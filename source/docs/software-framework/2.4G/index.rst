...
请问SI24R1国产芯片模组NF-03是否支持多通一？
----------------------
需做好时间分配，模组只有一个通道用于收发；

NF-02-PA模块怎样才能勾达到2Mbps的传输速率
---------------
通过SPI读写相关寄存器进行操作

请问Si25R1模块是否有一个固定的物理地址？如何区分模组？
-----------------------
没有物理地址，需在MCU上面做区分；

2.4G模块经常发送会一直显示达到最大重发次数的问题，该如何解决
------------------
检查下是否有清除TX_DS或MAX_RT中断

纯2.4G模组支持重新烧写代码吗
---------------
不支持，该模组属于纯射频模组，出厂已固化程序，不可重新烧写

NF-01-S模组射频信号可以穿透塑料外壳吗
-----------------
模组射频信号可以穿透塑料外壳