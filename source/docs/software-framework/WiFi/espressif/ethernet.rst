...
ESP32-S,ESP-WROOM-32,ESP32-A1S模组有什么区别?
-----------------------------------------------------------------------------------------

答：ESP32-S与ESP32-WROOM-32为通用类型的模组，软硬件部分，除了天线形式有差异，其他部分都一样，ESP32-A1S模组内置AC101音频解码芯片，可以进行音频相关的开发，支持播放音乐和录音


nodemcu32的开发板下载需要注意什么?
-----------------------------------------------------------------------------------------

答：串口驱动是否安装，接线是否良好，点击START出现等待电平同步的时候有没有长按IO0按钮
