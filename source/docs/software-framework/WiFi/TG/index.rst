...
TG-12F模块支持二次开发吗？是不是阿里的license也在里面了
--------------
...
TG-12F开发板上电在调试时发现有个问题 用AT指令发送任和数据 返回的都是OK，是怎么回事
--------------
