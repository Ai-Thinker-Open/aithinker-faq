...
TG-12F开发板的开发资料
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
`参考资料 <https://blog.csdn.net/Boantong%5F/article/details/110559410>`__
...
请问TG-12F模组是否自带固件，免配置，直接贴到底板供电就可以使用？
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
TG-12F模组自带AT固件，需要用户通过串口配置AT指令的方式实现入网需求。
