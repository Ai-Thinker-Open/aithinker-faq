...
WB2-32S开发板有几个串口可以使用，为什么好多引脚都是NC
-------------------
开发板有2个串口可以使用，通过软件定义实现，NC引脚表示该引脚为悬空引脚，不可使用

WB2系列的串口支持硬件流控吗
---------------
需做开发实现，默认不支持硬件流控

请问WB2-32S模组没有SDIO接口么？
-------------------
有的；
 .. image:: img/sdio.jpg

WB2-07S这个RST引脚和EN引脚有什么区别吗
----------------------
没有区别，只是模块默认通过EN引脚进行复位，如果需要通过RST进行复位需要修改模组内部硬件实现